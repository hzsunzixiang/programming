# Class: pyapp::params
#
# This class defines default parameters used by the main module class pyapp
# Operating Systems differences in names and paths are addressed here
#
# == Variables
#
# Refer to pyapp class for the variables defined here.
#
# == Usage
#
...
class pyapp::params {
  ...
  $app_source_dir = 'puppet:///modules/pyapp/scripts/java-app'
  # template 模板地址
  $app_source_file = 'pyapp/java/javaApp.erb'
  $service_status =  true
