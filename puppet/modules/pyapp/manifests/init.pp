...
class pyapp (
  ...
  ) inherits pyapp::params {


#    # 部署文件 形如 pyapp-cloud-nbs-ha-recover
#    file { "/home/$process_user/pyapp-$app_name_suffix":
#      ensure                  => directory,
#      group                   => $process_group,
#      mode                    => 0755 ,
#      owner                   => $process_user,
...
#
#      "/home/$process_user/py-$app_name_suffix/pyApp":
#      ensure                  => file,
#      group                   => $process_group,
#      mode                    => 0755 ,
#      owner                   => $process_user,
...
#      require                 => File["/home/$process_user/py-$app_name_suffix"];
#
#      "/etc/init.d/$service":
#      ensure                  => file,
#      group                   => $process_group,
...
#    }
#
#    file { "/home/$process_user/pyapp-$app_name_suffix/$package_name":
#      ensure                  => file,
#      group                   => $process_group,
#      mode                    => 0644 ,
#      owner                   => $process_user,
...
#      checksum                => md5,
#      require                 => File["/home/$process_user/pyapp-$app_name_suffix"],
...
#          cwd     => "/home/$process_user/pyapp-$app_name_suffix",
#          user    => $process_user,
#          path    => ["/usr/local/sbin","/usr/local/bin","/usr/sbin","/usr/bin","/sbin","/bin"],
#          require => File["/home/$process_user/pyapp-$app_name_suffix/$package_name"],
#          refreshonly =>true
#    }
#
### 覆盖配置文件
...
#      require                 => [ File["/home/$process_user/pyapp-$app_name_suffix"], Exec["unzip-and-clean"] ],
