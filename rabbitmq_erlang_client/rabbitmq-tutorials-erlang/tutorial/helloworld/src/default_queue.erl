...
declare_queue(Channel) ->
    ...
    Declare = #'queue.declare'{exclusive = true},
...
start() ->
   Connection=default_queue:connect_amqp(),
   Channel=default_queue:open_channel(Connection),
   Q=default_queue:declare_queue(Channel),
   default_queue:publish_message(Channel, Q),
