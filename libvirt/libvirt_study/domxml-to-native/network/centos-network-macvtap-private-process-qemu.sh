...
-S \
-object secret,id=masterKey0,format=raw,file=/var/lib/libvirt/qemu/domain-46-centos-network-isola/master-key.aes \
...
-no-user-config \
-nodefaults \
-chardev socket,id=charmonitor,fd=43,server,nowait \
...
-netdev tap,fd=45,id=hostnet0,vhost=on,vhostfd=46 \
