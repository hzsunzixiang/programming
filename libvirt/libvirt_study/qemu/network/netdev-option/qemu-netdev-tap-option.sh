...
-netdev tap,id=nd1,ifname=tap1 -device e1000e,netdev=nd1 \
-netdev tap,id=nd2,ifname=tap2 -device rtl8139,netdev=nd2 \
-netdev tap,id=nd3,ifname=tap3 -device virtio-net,netdev=nd3 \
