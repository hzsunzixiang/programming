...
-netdev user,id=nd0,ipv6=off -device e1000,netdev=nd0 \
-netdev user,id=nd1,ipv6=off -device e1000e,netdev=nd1 \
-netdev user,id=nd2,ipv6=off -device rtl8139,netdev=nd2 \
-netdev user,id=nd3,ipv6=off -device virtio-net,netdev=nd3 \
