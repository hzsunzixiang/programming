...
.Ltext0:
	...
	.align 8
.LC1:
	.string	"start minDistance:(if (sptSet[v] == false && dist[v] <= min))"
.LC2:
	.string	"INT_MAX"
.LC3:
	.string	"(v:%d min:%s, min_index:%d),"
.LC4:
	.string	"(v:%d min:%d, min_index:%d),"
.LC5:
	.string	"min_index:%d end minDistance\n"
	.text
	.globl	_Z11minDistancePiPb
	.type	_Z11minDistancePiPb, @function
_Z11minDistancePiPb:
.LFB0:
	.file 1 "main_note.cpp"
	.loc 1 16 0
	.cfi_startproc
	pushq	%rbp
...
.LC13:
	.string	"%s,"
.LC14:
	.string	"debug: u:%d, vertex:%d\n"
	.align 8
.LC15:
	.string	"!sptSet[%d] && graph[%d][%d] && dist[%d] != INT_MAX && dist[%d]+graph[%d][%d] < dist[%d]\n"
.LC16:
	.string	"change dist[%d]=%d\n"
.LC17:
	.string	"\n"
	.text
