...
local f_xid = ProtoField.bytes("zab.xid", "Transaction ID")
...
local f_zxid = ProtoField.bytes("zab.zxid", "ZxID")
local f_zxid_epoch = ProtoField.uint64("zab.zxid.epoch", "Epoch")
local f_zxid_count = ProtoField.uint64("zab.zxid.count", "Count")
local f_czxid = ProtoField.bytes("zab.czxid", "Created ZxID")
local f_czxid_epoch = ProtoField.uint64("zab.czxid.epoch", "Epoch")
local f_czxid_count = ProtoField.uint64("zab.czxid.count", "Count")
local f_mzxid = ProtoField.bytes("zab.mzxid", "Last Modified ZxID")
local f_mzxid_epoch = ProtoField.uint64("zab.mzxid.epoch", "Epoch")
local f_mzxid_count = ProtoField.uint64("zab.mzxid.count", "Count")
local f_pzxid = ProtoField.bytes("zab.pzxid", "Last Modified Children ZxID")
local f_pzxid_epoch = ProtoField.uint64("zab.pzxid.epoch", "Epoch")
local f_pzxid_count = ProtoField.uint64("zab.pzxid.count", "Count")
local f_timeout = ProtoField.int64("zab.timeout", "Timeout")
local f_session = ProtoField.bytes("zab.session", "Session ID")
