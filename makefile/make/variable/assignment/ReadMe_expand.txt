...
Free disk space /usr/bin/df . | /usr/bin/awk 'NR == 2 { print $4 }'
19635796

# Make data base, printed on Wed Apr 12 04:46:45 2023
...
FC = f77
# makefile
.DEFAULT_GOAL := /tmp/very_big_file
# automatic
%D = $(patsubst %/,%,$(dir $%))
# default
WEAVE = weave
...
# Load=129/1024=13%, Rehash=0, Collisions=14/164=9%
...
# . (device 64768, inode 10439087): 13 files, 19 impossibilities.
# RCS: could not be stat'd.

# 13 files, 19 impossibilities in 3 directories.
...
#  Last modified 2023-04-12 04:46:36.279011413
...
# # of strings in strcache: 0 / lookups = 441 / hits = 441
# # of strcache buffers: 1 (* 8176 B/buffer = 8176 B)
# strcache used: total = 0 (2642) / max = 0 / min = 8176 / avg = 0
# strcache free: total = 0 (5534) / max = 0 / min = 8176 / avg = 0

# strcache hash-table stats:
# Load=250/8192=3%, Rehash=0, Collisions=177/441=40%
# Finished Make data base on Wed Apr 12 04:46:45 2023
