...
make: `gui.o' is up to date.

# Make data base, printed on Wed Apr 12 05:03:27 2023
...
MAKE_VERSION := 3.82
# makefile
CURDIR := /home/ericksun/programming/makefile/make/variable/assignment
# makefile
SHELL = /bin/sh
# default
RM = rm -f
...
LINK.C = $(LINK.cc)
# environment
PWD = /home/ericksun/programming/makefile/make/variable/assignment
# default
...
# Load=123/1024=12%, Rehash=0, Collisions=12/145=8%
...
# . (device 64768, inode 10439087): 17 files, 22 impossibilities.
# RCS: could not be stat'd.

# 17 files, 22 impossibilities in 3 directories.
...
#  Last modified 2023-04-12 04:57:58.205791655
...
Makefile:
#  Implicit rule search has been done.
#  Last modified 2023-04-12 05:03:19.708874137
#  File has been updated.
#  Successfully updated.
...
gui.o: gui.c
#  Implicit rule search has not been done.
#  Last modified 2023-04-12 05:03:23.164928772
#  File has been updated.
#  Successfully updated.
# makefile (from `Makefile', line 1)
# MYCPPFLAGS += -DUSE_NEW_MALLOC=1
# variable set hash-table stats:
...
# Load=76/1024=7%, Rehash=0, Collisions=421/1510=28%
# VPATH Search Paths
...
# # of strings in strcache: 0 / lookups = 480 / hits = 480
# # of strcache buffers: 1 (* 8176 B/buffer = 8176 B)
# strcache used: total = 0 (2897) / max = 0 / min = 8176 / avg = 0
# strcache free: total = 0 (5279) / max = 0 / min = 8176 / avg = 0

# strcache hash-table stats:
# Load=277/8192=3%, Rehash=0, Collisions=177/480=37%
# Finished Make data base on Wed Apr 12 05:03:27 2023
