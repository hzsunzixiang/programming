...
#define SRP_DAEMON_CONFIG_FILE "/usr/local/etc/srp_daemon.conf"
#define SRP_DAEMON_LOCK_PREFIX "/usr/local/var/run/srp_daemon"

#define ACM_CONF_DIR "/usr/local/etc/rdma"
#define IBACM_LIB_PATH "/usr/local/lib64/ibacm"
...
#define VERBS_PROVIDER_DIR "/usr/local/lib64/libibverbs"
#define VERBS_PROVIDER_SUFFIX "-rdmav57.so"
#define IBVERBS_PABI_VERSION 57
...
#define HAVE_SOCKADDR_ARG_AS_UNION 1
