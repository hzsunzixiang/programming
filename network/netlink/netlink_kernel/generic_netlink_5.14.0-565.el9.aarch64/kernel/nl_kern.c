...
int family1_recv(struct sk_buff *skb_temp, struct genl_info *info) {
    ...
    if (na) {
         ...
         * Validate attributes
        */
        is_valid = nla_validate(na, na->nla_len, FAMILY1_A_MAX, family1_genl_policy, NULL);
