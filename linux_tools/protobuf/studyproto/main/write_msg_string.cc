...
int main(int argc, char* argv[]) {
	...
	assert(address_book.SerializePartialToString(&msgAddress));
	unsigned int msgAddrsize = address_book.ByteSize();
	cout<<"msgAddrsize:\t"<<msgAddrsize<<"\t"<<msgAddress.size()<<endl;
	//cout<<msgAddress<<endl;
	...
	address_book_1.ParsePartialFromString(msgAddress);
