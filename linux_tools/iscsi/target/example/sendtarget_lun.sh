...
device1=loop3
auth=$2
iqn=test:123456:${device1}
lun=iscsi01

tcm_node --block iblock_0/test_${device} /dev/${device} 
tcm_node --block iblock_0/test_${device1} /dev/${device1} 
#lio_node --addlun <TargetIQN> <TPG#> <LUN#> <LUNName> <HBA>/<StorageObjectName>
lio_node --addlun test:123456:${device1} 1 0 $lun iblock_0/test_${device} 
lio_node --addlun test:123456:${device1} 1 1 $lun iblock_0/test_${device1} 
lio_node --listendpoints
lio_node --addnp test:123456:${device1} 1 0.0.0.0:3260 
