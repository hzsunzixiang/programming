...
start() ->
    ...
    HandlerConfigOrigin = #{id => default,module => logger_std_h, formatter => {logger_formatter,#{template => [time," ",file,", ",mfa,":",line," ",pid," ", gl," ",level,": ","{{[", foo ,"]}}\t",msg, "\n"]}}}, 


    logger:set_handler_config(default, HandlerConfigOrigin),
    Metadata=
        #{pid => self(),
          gl => group_leader(), 
