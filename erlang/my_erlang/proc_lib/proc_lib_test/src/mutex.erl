...
start_link(Name, DbgOpts) ->
    spawn_link(?MODULE, init, [self(), Name, DbgOpts]).
% 这里使用 spawn_link 无法启动，必须使用 proc_lib
%Eshell V13.0.4  (abort with ^G)
%1> =SUPERVISOR REPORT==== 9-Feb-2023::22:56:17.112539 ===
%    supervisor: {local,proc_lib_test_sup}
%    errorContext: start_error
%    reason: <0.149.0>
%    offender: [{pid,undefined},
%               {id,mutex},
%               {mfargs,{mutex,start_link,[printer,[trace,log]]}},
