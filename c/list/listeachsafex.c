...
int main(){
    ...
    do { (&student_list2)->next = (&student_list2); (&student_list2)->prev = (&student_list2); } while (0);
    ...
    flist_add( &(s->list), &student_list);
    flist_add( &(s1->list), &student_list);
    struct flist_head *pos;
    struct student *tmp_student;
    for (pos = (&student_list)->next; pos != (&student_list); pos = pos->next)
    {
