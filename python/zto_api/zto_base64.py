...
try: 
	...
	#body = urllib.urlencode({'data': wl_info_json.encode("utf8")})
	print "wl_info_json",wl_info_json
	print "wl_info_json:",wl_info_json.decode("utf-8")
	body = urllib.urlencode({'data': wl_info_json})
	print "body:", body 
except Exception, e:
