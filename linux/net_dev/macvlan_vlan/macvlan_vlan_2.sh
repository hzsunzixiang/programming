...
ip netns exec ns11 ip addr add 192.168.10.13/24 dev macvlan11 

ip netns exec ns12 ip link set macvlan12  up
ip netns exec ns12 ip addr add 192.168.10.14/24 dev macvlan12

ip netns exec ns21 ip link set macvlan21  up
ip netns exec ns21 ip addr add 192.168.10.23/24 dev macvlan21
