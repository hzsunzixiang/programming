...
class Connection(pika.compat.AbstractBase):
    ...
    def _on_connection_tune(self, method_frame):
        ...
        LOGGER.debug('ericksun debug method_frame.method.heartbeat %s' % method_frame.method.heartbeat)
        if callable(self.params.heartbeat):
            LOGGER.debug('ericksun debug callable(self.params.heartbeat)')
            ...
            LOGGER.debug('ericksun debug not callable(self.params.heartbeat)')
